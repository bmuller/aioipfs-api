...
class IPFSInterface:
    ...
    async def add(self, path, **kwargs):
        ...
        :param only_hash: Only chunk and hash - do not write to disk. (bool)  Default: False
        ...
        :param hash: Hash function to use. Implies CIDv1 if not sha2-256. (experimental). (string)  Default: sha2-256
    ...
    async def files_stat(self, path, **kwargs):
        ...
        ChildBlocks: <childs>
        Type: <type>
        :param hash: Print only hash. Implies '--format=<hash>'. Conflicts with other format options. (bool)  Default: False
